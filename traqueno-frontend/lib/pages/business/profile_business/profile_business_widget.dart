...
export 'profile_business_model.dart';

class ProfileBusinessWidget extends StatefulWidget {
  const ProfileBusinessWidget({Key? key}) : super(key: key);

  @override
  _ProfileBusinessWidgetState createState() => _ProfileBusinessWidgetState();
}
    ...
    return Scaffold(
      ...
      body: FutureBuilder<ApiCallResponse>(
        ...
        builder: (context, snapshot) {
          ...
          final columnGetUserByIDResponse = snapshot.data!;
          return Column(
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Image.asset(
                                          'assets/images/barber_shop.jpeg',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                      ...
                      children: [
                        Container(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed('agendaBusiness');
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                      ...
                      children: [
                        Container(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.pushNamed('reviewsBusiness');
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              children: [
