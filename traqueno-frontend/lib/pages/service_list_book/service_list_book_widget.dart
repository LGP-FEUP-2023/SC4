...
import 'service_list_book_model.dart';
...
class _ServiceListBookWidgetState extends State<ServiceListBookWidget> {
  late ServiceListBookModel _model;
        ...
        body: Column(
          ...
          children: [
            InkWell(
              ...
              onTap: () async {
                context.pushNamed('serviceDetailListBook');
              },
              child: ListView(
